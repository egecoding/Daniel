        ...
        <div className='account__switcher-dropdown-wrapper show' ref={dropdownRef}>
            <div id='account__switcher-dropdown' className='account__switcher-dropdown' ref={container_ref}>
                <div className='account__switcher-container'>
                    ...
                    {shouldShowRealAcc({ title: 'Digits Differ Bots', acc: automatedBots['digit_differs'], isMain: true })}
                    {shouldShowRealAcc({ title: 'Over & Under Bots', acc: automatedBots['over_under'], isMain: true  })}
                    {shouldShowRealAcc({ title: 'Rise & Fall Bots', acc: automatedBots['rise_fall'], isMain: true  })}
                    <BotsTabContent
                        tab='demo'
                        isActive={is_demo}
