    ...
    return (
        <div id='toolbox'>
            ...
            {config.analysis_tool_chart.url && (
                <ToolboxButton
                    label={<BsBarChartLineFill size={20} />}
                    id='analysisToolButton'
                    tooltip={translate('Show Analysis Tool')}
                    position='bottom'
                    classes='toolbox-button'
                    onClick={() => {
                        if (!analysisTool) {
            ...
            <ToolboxButton
                label={<FaRobot  size={23} />}
                id='custombots_button'
                tooltip={translate('Show PreSaved Bots')}
                position='bottom'
                classes='toolbox-button'
                onClick={() => {
