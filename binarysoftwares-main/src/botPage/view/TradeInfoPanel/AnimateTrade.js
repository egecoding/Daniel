...
import { resetMartingaleVars } from '../../../blockly/blocks/tools/vh_functions';

const INDICATOR_MESSAGES = {
    not_running: translate('Software is not running.'),
    starting: translate('Software is starting...'),
    running: translate('Software is running...'),
    stopping: translate('Software is stopping...'),
    stopped: translate('Software has stopped.'),
};
