...
const TradeInfoPanel = () => {
    ...
    return (
        <span id='summary-panel' className='draggable-dialog' title={translate('Trade History')}>
            <div>
                <div className='content'>
                    ...
                    <div className='content-row' style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: 0 }}>
                        <AnimateTrade />
                        {/* <a href='https://t.me/automatedbinarybots' style={{ textAlign: 'center', color: '#000', textDecoration: 'none', padding: 0 }}>
